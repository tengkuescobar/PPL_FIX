...
**Views**
```
resources/views/dashboard.blade.php        ← ringkasan progres + kursus aktif + progress bar
resources/views/my-courses/index.blade.php ← list semua kursus yang diikuti
```

**Routes** (`routes/web.php`, grup `auth`)
```php
...
### Checklist
- [ ] Dashboard menampilkan daftar kursus aktif + progress bar persentase

---

## PBI-5 – Akses Materi & Video
...
**Views**
```
resources/views/courses/learn.blade.php   ← video player + konten teks modul + tombol "Tandai Selesai"
```
...
### Checklist
- [ ] Modul teks tampil di halaman, video embed/player berfungsi, tombol "Tandai Selesai"
...
**Views**
```
resources/views/courses/quiz.blade.php   ← form kuis pilihan ganda + tampilkan skor setelah submit
```
...
### Checklist
- [ ] Kuis tampil setelah modul, submit menampilkan skor & status lulus/tidak
